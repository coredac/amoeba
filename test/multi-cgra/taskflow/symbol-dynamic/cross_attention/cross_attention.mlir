...
// NEURA-NEXT:       %4 = taskflow.counter from %c0_58 to %arg6 step %c1 attributes {counter_id = 0 : i32, counter_type = ["root", "symbol_dynamic"]} : index
// NEURA-NEXT:       %5 = taskflow.counter parent(%4 : index) from %c0_58 to %c64 step %c1 attributes {counter_id = 1 : i32, counter_type = ["relay", "static"]} : index
// NEURA-NEXT:       %6 = taskflow.counter parent(%5 : index) from %c0_58 to %c64 step %c1 attributes {counter_id = 2 : i32, counter_type = ["leaf", "static"]} : index
...
// NEURA-NEXT:         %7 = neura.counter from %c0_60 : index to %arg10 : index step %c1_61 : index attributes {counter_id = 0 : i32, counter_type = ["root", "symbol_dynamic"]} -> index
// NEURA-NEXT:         %8 = neura.counter from %c0_60 : index to %c64_59 : index step %c1_61 : index attributes {counter_id = 1 : i32, counter_type = ["relay", "static"]} -> index
// NEURA-NEXT:         %9 = neura.counter from %c0_60 : index to %c64_59 : index step %c1_61 : index attributes {counter_id = 2 : i32, counter_type = ["leaf", "static"]} -> index
