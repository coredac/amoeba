...
// RESOPT-NEXT:       %1 = taskflow.counter from %c0_4 to %c4 step %c1 attributes {counter_id = 0 : i32, counter_type = ["root", "static"]} : index
// RESOPT-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_4 to %c8 step %c1 attributes {counter_id = 1 : i32, counter_type = ["relay", "static"]} : index
// RESOPT-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_4 to %c5 step %c1 attributes {counter_id = 2 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:         %4 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["root", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 4 : index} -> !neura.data<index, i1>
// RESOPT-NEXT:         %5 = neura.counter attributes {counter_id = 1 : i32, counter_type = ["relay", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 8 : index} -> !neura.data<index, i1>
// RESOPT-NEXT:         %6 = neura.counter attributes {counter_id = 2 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 5 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:       %1 = taskflow.counter from %c0_4 to %c4 step %c1 attributes {counter_id = 0 : i32, counter_type = ["root", "static"]} : index
// RESOPT-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_4 to %c8 step %c1 attributes {counter_id = 1 : i32, counter_type = ["relay", "static"]} : index
// RESOPT-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_4 to %c6 step %c1 attributes {counter_id = 2 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:         %7 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["root", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 4 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:         %9 = neura.counter attributes {counter_id = 2 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 6 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:         %15 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["root", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 4 : index} -> !neura.data<index, i1>
// RESOPT-NEXT:         %16 = neura.counter attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 7 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:       %4 = taskflow.counter from %c0_5 to %c4_6 step %c1_7 attributes {counter_id = 0 : i32, counter_type = ["root", "static"]} : index
// RESOPT-NEXT:       %5 = taskflow.counter parent(%4 : index) from %c0_5 to %c7 step %c1_7 attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:       %c1 = arith.constant 1 : index
// RESOPT-NEXT:       %1 = taskflow.counter from %c0_4 to %c4 step %c1 attributes {counter_id = 0 : i32, counter_type = ["root", "static"]} : index
// RESOPT-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_4 to %c9 step %c1 attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:         %3 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["root", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 4 : index} -> !neura.data<index, i1>
// RESOPT-NEXT:         %4 = neura.counter attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 9 : index} -> !neura.data<index, i1>
