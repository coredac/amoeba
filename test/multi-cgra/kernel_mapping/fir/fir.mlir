...
// KERNEL-NEXT:       %0 = taskflow.counter from %c0 to %c32 step %c1 attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} : index
...
// KERNEL-NEXT:         %2 = neura.counter from %c0_0 : index to %c32_1 : index step %c1_2 : index attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} -> index
...
// NEURA-NEXT:       %0 = taskflow.counter from %c0 to %c32 step %c1 attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} : index
...
// NEURA-NEXT:         %5 = neura.counter from %2 : index to %3 : index step %4 : index attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} -> index
...
// DATAFLOW-NEXT:       %0 = taskflow.counter from %c0 to %c32 step %c1 attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} : index
...
// DATAFLOW-NEXT:         %5 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 32 : index} -> !neura.data<index, i1>
...
// MAPPED-NEXT:       %0 = taskflow.counter from %c0 to %c32 step %c1 attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} : index
...
// MAPPED-NEXT:         %6 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"], dfg_id = 2 : i32, lower_bound_value = 0 : index, mapping_locs = [{id = 0 : i32, index_per_ii = 0 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 0 : i32, x = 0 : i32, y = 0 : i32}], step_value = 1 : index, upper_bound_value = 32 : index} -> !neura.data<index, i1>
