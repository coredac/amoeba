...
// NEURA-NEXT:       %10 = taskflow.counter parent(%9 : index) from %c0 to %arg5 step %c1 attributes {counter_dynamism = "irregular_dynamic", counter_hierarchy = "relay", counter_id = 2 : i32} : index
...
// NEURA-NEXT:         %15 = neura.counter from %c0_24 : index to %arg9 : index step %c1_25 : index attributes {counter_dynamism = "irregular_dynamic", counter_hierarchy = "relay", counter_id = 2 : i32} -> index
