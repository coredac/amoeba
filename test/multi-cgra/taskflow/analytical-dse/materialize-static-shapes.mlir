...
// RUN: mlir-amoeba-opt %t.materialized.mlir \
// RUN:   '--orchestrate-tasks-on-accelerators=orchestration-strategy=analytical-based-task-orchestration scheduling-mode=spatial' \
...
// UNBOUND: analytical-based task orchestration requires a non-empty analytical_task_candidate_id attribute
