...
// CHECK-NEXT:     %dependency_read_out, %dependency_write_out = taskflow.task @Task_0 dependency_read_in(%arg0 : memref<64xf32>) dependency_write_in(%arg0 : memref<64xf32>) value_inputs(%arg3 : f32) [original_read_memrefs(%arg0 : memref<64xf32>), original_write_memrefs(%arg0 : memref<64xf32>)] {task_mapping_info = {cgra_positions = [{col = 0 : i32, duration = {{[0-9]+}} : i32, row = 0 : i32, start_time = 0 : i32}, {col = 1 : i32, duration = {{[0-9]+}} : i32, row = 0 : i32, start_time = 0 : i32}], read_sram_locations = [{col = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32}], write_sram_locations = [{col = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32}]}} : (memref<64xf32>, memref<64xf32>, f32) -> (memref<64xf32>, memref<64xf32>) {
...
// CHECK-NEXT:     }
// CHECK-NEXT:     %dependency_read_out_0, %dependency_write_out_1 = taskflow.task @Task_1 dependency_read_in(%dependency_write_out : memref<64xf32>) dependency_write_in(%arg1 : memref<64xf32>) value_inputs(%dependency_read_out : memref<64xf32>) [original_read_memrefs(%arg0 : memref<64xf32>), original_write_memrefs(%arg1 : memref<64xf32>)] {task_mapping_info = {cgra_positions = [{col = {{[0-9]+}} : i32, duration = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32, start_time = {{[0-9]+}} : i32}], read_sram_locations = [{col = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32}], write_sram_locations = [{col = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32}]}} : (memref<64xf32>, memref<64xf32>, memref<64xf32>) -> (memref<64xf32>, memref<64xf32>) {
// CHECK-NEXT:     ^bb0(%arg4: memref<64xf32>, %arg5: memref<64xf32>, %arg6: memref<64xf32>):
// CHECK-NEXT:       taskflow.yield reads(%arg4 : memref<64xf32>) writes(%arg5 : memref<64xf32>)
// CHECK-NEXT:     }
// CHECK-NEXT:     %dependency_read_out_2, %dependency_write_out_3 = taskflow.task @Task_2 dependency_read_in(%dependency_write_out_1 : memref<64xf32>) dependency_write_in(%arg2 : memref<64xf32>) value_inputs(%dependency_read_out_0 : memref<64xf32>) [original_read_memrefs(%arg1 : memref<64xf32>), original_write_memrefs(%arg2 : memref<64xf32>)] {task_mapping_info = {cgra_positions = [{col = {{[0-9]+}} : i32, duration = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32, start_time = {{[0-9]+}} : i32}], read_sram_locations = [{col = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32}], write_sram_locations = [{col = {{[0-9]+}} : i32, row = {{[0-9]+}} : i32}]}} : (memref<64xf32>, memref<64xf32>, memref<64xf32>) -> (memref<64xf32>, memref<64xf32>) {
// CHECK-NEXT:     ^bb0(%arg4: memref<64xf32>, %arg5: memref<64xf32>, %arg6: memref<64xf32>):
// CHECK-NEXT:       taskflow.yield reads(%arg4 : memref<64xf32>) writes(%arg5 : memref<64xf32>)
// CHECK-NEXT:     }
// CHECK-NEXT:     return
