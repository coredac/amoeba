...
// KERNEL-NEXT:         %1 = neura.counter from %c0_0 : index to %c32_1 : index step %c1_2 : index attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} -> index
...
// NEURA-NEXT:         %4 = neura.counter from %1 : index to %2 : index step %3 : index attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} -> index
...
// DATAFLOW-NEXT:         %1 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 32 : index} -> !neura.data<index, i1>
...
// MAPPED-NEXT:         %1 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"], dfg_id = 0 : i32, lower_bound_value = 0 : index, mapping_locs = [{id = 5 : i32, index_per_ii = 0 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 0 : i32, x = 1 : i32, y = 1 : i32}], step_value = 1 : index, upper_bound_value = 32 : index} -> !neura.data<index, i1>
