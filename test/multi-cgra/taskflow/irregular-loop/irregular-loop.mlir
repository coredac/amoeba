...
// MAP-SPATIAL-TEMPORAL-NEXT:     %value_outputs = taskflow.task @Task_0 value_inputs(%c0_i32 : i32) {profile_info = {duration = 1 : i32}, task_orchestration_info = {cgra_positions = [{col = 0 : i32, context_id = 0 : i32, row = 0 : i32}], read_sram_locations = [], write_sram_locations = []}} : (i32) -> (i32) {
...
// RESOPT-NEXT:       %1 = taskflow.counter from %c0 to %c5 step %c1 attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:         %8 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 5 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:         %14 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["root", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 4 : index} -> !neura.data<index, i1>
// RESOPT-NEXT:         %15 = neura.counter attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 8 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:       %3 = taskflow.counter from %c0_2 to %c4 step %c1_3 attributes {counter_id = 0 : i32, counter_type = ["root", "static"]} : index
// RESOPT-NEXT:       %4 = taskflow.counter parent(%3 : index) from %c0_2 to %c8 step %c1_3 attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:       %c4 = arith.constant 4 : index
// RESOPT-NEXT:       %c1 = arith.constant 1 : index
// RESOPT-NEXT:       %1 = taskflow.counter from %c0 to %c4 step %c1 attributes {counter_id = 0 : i32, counter_type = ["root", "static"]} : index
// RESOPT-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0 to %c8 step %c1 attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:         %4 = neura.counter attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 8 : index} -> !neura.data<index, i1>
