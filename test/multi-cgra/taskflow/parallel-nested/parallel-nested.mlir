...
// MAP-SPATIAL-TEMPORAL-NEXT:       %1 = taskflow.counter parent(%0 : index) from %c0 to %c8 step %c1 : index
...
// RESOPT-NEXT:       %0 = taskflow.counter from %c0 to %c16 step %c1 attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"]} : index
...
// RESOPT-NEXT:         %3 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 16 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:         %6 = neura.counter attributes {counter_id = 0 : i32, counter_type = ["root", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 8 : index} -> !neura.data<index, i1>
// RESOPT-NEXT:         %7 = neura.counter attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"], lower_bound_value = 0 : index, step_value = 1 : index, upper_bound_value = 8 : index} -> !neura.data<index, i1>
...
// RESOPT-NEXT:       %1 = taskflow.counter from %c0_0 to %c8 step %c1_1 attributes {counter_id = 0 : i32, counter_type = ["root", "static"]} : index
// RESOPT-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_0 to %c8 step %c1_1 attributes {counter_id = 1 : i32, counter_type = ["leaf", "static"]} : index
